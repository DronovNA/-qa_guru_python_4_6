...
def test_dark_theme_by_time_and_user_choice():
    ...
    is_dark_theme = None
    if (
        time(22) <= current_time
        or current_time <= time(6)
        or dark_theme_enabled_by_user is True
    ):
        is_dark_theme = True
    else:
        is_dark_theme = False
...
def test_find_suitable_user():
    ...
    suiable_users = [age for age in users if age["age"] < 20]
